    ...
    <div className="screen center">
      ...
      {phase === 'show' ? (
        ...
        <div className="col fade">
          ...
          {isSentence && (peek ? <div className="parent-note"><b>Grown-up reads:</b> "{item.sentence}" <button className="btn ghost" onClick={() => setPeek(false)}>hide</button></div> : <button className="btn ghost" onClick={() => setPeek(true)}>Grown-up: peek at the sentence</button>)}
