...
3d. **Moving her along (grown-up).** Home has a small *⏭ Go to the next rule · grown-up* button (PIN): it marks the rule she's on as done, gives its badge and opens the next rule. In Grown-ups → Settings → *Rules and progress* you can *Mark done* / *Undo done* any rule, or *Start here* on the rule she should do next. Marked rules can still be redone from *Do a rule again*. The same panel shows how many lessons are saved on the device.
